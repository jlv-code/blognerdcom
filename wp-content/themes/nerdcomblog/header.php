...
<body <?php body_class(); ?>>
    <div class="container-fluid">
        <header id="header" class="row header mobile-header">
            <div class="container">
                <div class="row">
                    <div class="container-fluid">
                        ...
                        <div class="logo">
                            <a href="/"><img src="<?php echo get_template_directory_uri() ?>/dist/images/logon.png" alt="anerdcom" class="img-fluid"></a>
                        </div>
                        <div class="logo-white">
                            <a href="/"><img src="<?php echo get_template_directory_uri() ?>/dist/images/logob.png" alt="bnerdcom" class="img-fluid"></a>
                        </div>
                        <nav class="navigation nav-item">
                            <ul class="secondary-menu list-unstyled nav">
                                <li class="nav-item d-lg-none"><a href="tel:+1.929.273.0923"><i class="fas fa-phone text-white"></i></a></li>
                                <li class="nav-item d-lg-none"><a href="https://www.nerdcom.host/support"><i class="fa fa-question-circle text-white"></i></a></li>
                                <li class="nav-item d-lg-none"><a href="https://www.panel.nerdcom.host/"><i class="fa fa-user text-white"></i></a></li>
                                <li class="nav-item d-lg-none"><a href="https://panel.nerdcom.host/cart.php?a=view"><i class="fa fa-shopping-cart fa-fw text-white"></i></a></li>
                            </ul>
                            <ul class="main-menu list-unstyled nav">
                                <li class="nav-item">
                                    ...
                                    <div class="sub-menu">
                                        ...
                                        <div class="sub-menu-foot d-none d-lg-block">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="sub-menu">
                                        <ul class="menu list-unstyled">
                                            ...
                                            <li class="domain-include d-none d-lg-block">
                                                <span>Incluye</span>
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="sub-menu">
                                        <ul class="menu list-unstyled">
                                            ...
                                            <li class="security-design d-none d-lg-block">
                                        ...
                                        <ul class="menu list-unstyled">
                                            <li>
                                                ...
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li><a class="link-title-company" href="comming-soon.html">KAI  <img src="<?php echo get_template_directory_uri() ?>/dist/images/kai.png" alt="nerdcom_kai"></a></li>
                                                </ul>
                                            </li>
                                            <li>
                                    ...
                                    <div class="sub-menu">
                                        <ul class="menu list-unstyled">
                                            <li class="text-left  text-lg-center">
                                                ...
                                                <img class="nav-img-contact d-none d-lg-block" src="<?php echo get_template_directory_uri() ?>/dist/images/supp.svg" alt="support">
                                            </li>
                                            <li class="text-left text-lg-center">
                                                <a class="link-title-center" href="comming-soon.html">Realiza una pregunta</a>
                                                <img class="nav-img-contact d-none d-lg-block" src="<?php echo get_template_directory_uri() ?>/dist/images/quest.svg" alt="quest">
                                            </li>
                                            <li class="text-left text-lg-center">
                                                <a class="link-title-center" href="comming-soon.html">Preguntas frecuentes</a>
                                                <img class="nav-img-contact d-none d-lg-block" src="<?php echo get_template_directory_uri() ?>/dist/images/faq.svg" alt="faq">
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                    ...
                                    <div class="sub-menu worldwide-menu">
                                        <ul class="menu list-unstyled">
                                            <li>
                                                <span>América</span>
                                                <ul class="list-unstyled">
                                                    <li><a href="comming-soon.html"><img class="flags" src="<?php echo get_template_directory_uri() ?>/dist/images/usa.png" alt="usa"> USA</a></li>
                                                    <li><a href="comming-soon.html"><img class="flags" src="<?php echo get_template_directory_uri() ?>/dist/images/republicadominicana.png" alt="rep_dominicana"> R. Dominicana</a></li>
                                                    <li><a href="comming-soon.html"><img class="flags" src="<?php echo get_template_directory_uri() ?>/dist/images/argentina.png" alt="argentina"> Argentina</a></li>
                                                    <li><a href="comming-soon.html"><img class="flags" src="<?php echo get_template_directory_uri() ?>/dist/images/mex.png" alt="mexico"> México</a></li>
                                                    <li><a href="comming-soon.html"><img class="flags" src="<?php echo get_template_directory_uri() ?>/dist/images/chile.png" alt="chile"> Chile</a></li>
                                                    <li><a href="comming-soon.html"><img class="flags" src="<?php echo get_template_directory_uri() ?>/dist/images/venezuela.png" alt="venezuela"> Venezuela</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <span>Europa</span>
                                                <ul class="list-unstyled">
                                                    <li><a href="comming-soon.html"><img class="flags" src="<?php echo get_template_directory_uri() ?>/dist/images/es.svg" alt="españa"> España</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </div>
        ...
        <main class="front-page-body row">
