        ...
        <footer id="footer" class="row footer">
            <div class="container">
                ...
                <div class="row footer-info">
                    <div class="col-lg-6">
                        <div class="logo"><a href="/"><img src="<?php echo get_template_directory_uri() ?>/dist/images/logon.png" alt="anerdcom" class="img-fluid"></a></div>
                    ...
                    <div class="col-lg-6">
                        <ul class="footer-menu-icons nav list-unstyled">
                            <li class="nav-item"><a href="comming-soon.html"><img src="<?php echo get_template_directory_uri() ?>/dist/images/visa.svg" alt="pay"></a></li>
                            <li class="nav-item"><a href="comming-soon.html"><img src="<?php echo get_template_directory_uri() ?>/dist/images/mastercard.svg" alt="pay"></a></li>
                            <li class="nav-item"><a href="comming-soon.html"><img src="<?php echo get_template_directory_uri() ?>/dist/images/amex.svg" alt="pay"></a></li>
                        </ul>
